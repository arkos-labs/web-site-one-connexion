-- ============================================================================
-- FIX DRIVER CREATION (SEARCH PATH FOR PGCRYPTO)
-- ============================================================================

BEGIN;

-- Mise à jour de la fonction RPC avec le bon search_path pour trouver pgcrypto (extensions)
...
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public, extensions -- AJOUT DE EXTENSIONS ICI
AS $$
DECLARE
    v_user_id UUID;
    v_email TEXT;
