# Plan d'action — oneconnexion.com (mis à jour 21/09/2026, lots 1 et 2 faits)
...
## Moyen (sous un mois)
- [x] Générer `lastmod` du sitemap à partir de la vraie date de modification de chaque page.
- [x] Titres à ≤60 caractères : /secteurs, /zones/courbevoie, /tarifs, /zones/la-defense.
- [x] Meta descriptions : /flotte (180 → ≤160), /zones/paris-19e, paris-15e, saint-maurice (→ 140-160).
- [x] Compléter /contact (adresse, horaires, délai de devis, `hasMap`).
- [x] Brancher le formulaire /contact sur Supabase (table contact_messages). Reste à être notifié des nouveaux messages.
- [ ] Collecter de vrais avis Google avant d'ajouter `aggregateRating`.
- [ ] Demander des mentions/backlinks réels (annuaires pro, partenaires, clients référencés avec leur accord).
