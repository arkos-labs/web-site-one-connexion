        ...
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    {/* Zone de drop */}
                    <div
                        className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${dragActive ? 'border-[#ed5518] bg-[#ed5518]/5' : 'border-gray-300'
                            }`}
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3 flex-1">
                                            <FileText className="h-8 w-8 text-[#ed5518] flex-shrink-0" />
