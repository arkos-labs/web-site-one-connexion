    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="flex w-full flex-col items-center justify-center bg-white p-6 lg:w-1/2 lg:p-14">
        <div className="w-full max-w-sm">
          ...
          {/* New: Google Login for Drivers/Clients */}
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-slate-400 font-bold mb-3 uppercase tracking-widest">
              Vous êtes chauffeur ?
            </p>
            <button
              type="button"
              ...
              className="w-full flex items-center justify-center gap-3 rounded-full border border-slate-200 bg-slate-50 py-3 text-xs font-black text-slate-600 hover:bg-white hover:border-[#ed5518] hover:text-[#ed5518] transition-all"
            >
              Accès Google Partenaire (Chauffeur)
            </button>
          </div>
        </div>
      </div>
